                ...
                <div id="post_bar">
                    <?php
                           ...
                           //echo  $next_page_link;
                            ...
                            $sql = "select * from users where Department='EEE'";
                            $result = read($sql);
                            $i=0;
                            ...
                            //$i=0;
                                ...
                                $eee_user = implode("','",$result);
                                
                                
                                
                               $myuserid = $_SESSION['mybook_userid'];
                                $sql = "select * from posts where parent = 0 and ( userid in('" .$eee_user. "')) order by id desc limit $limit offset $offset";
                                $posts =read($sql);
