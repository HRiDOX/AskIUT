    ...
    <div style="width: 800px;margin:auto; min-height:400px;">
        ...
        <div style="display: flex;">
            ...
            <div style="flex:1; min-height: 400px;">
                ...
                <div id="notice_board">
                    <h3>Resources For</h3>
                    <div id="Boo"><button class="glow-on-hover" type="button"><a class="link" href="mpe_repository.php">1st Year</a> </button></div>
                    <div id="Boo"><button class="glow-on-hover" type="button"><a class="link" href="cee_repository.php">2nd Year</a> </button></div>
                    <div id="Boo"><button class="glow-on-hover" type="button"><a class="link" href="eee_repository.php">3rd Year</a> </button></div>
                    <div id="Boo"><button class="glow-on-hover" type="button"><a class="link" href="cse_repository.php">4th Year</a> </button></div>
                ...
                <div id="post_bar">
                    <?php
                           ...
                           //echo  $next_page_link;
                            ...
                            $sql = "select * from users where Department='CSE' AND Year = '1st";
                            $result = read($sql);
                            $i=0;
                            ...
                            //$i=0;
                               ...
                               $myuserid = $_SESSION['mybook_userid'];
                                $sql = "select * from repository where  ( userid in('" .$cse_user. "')) order by id desc limit $limit offset $offset";
                                $posts =read($sql);
